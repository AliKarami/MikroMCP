...
Standard npm scripts — see `package.json`. Run `npm test` before pushing a branch (runs vitest, tsc, and eslint).
...
When cutting a release, invoke the `release` skill (`.claude/skills/release/SKILL.md`) — it holds the full 13-step checklist.
