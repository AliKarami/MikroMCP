...
[![Version](https://img.shields.io/badge/version-v1.6.0-EA580C)](package.json)
...
| v1.6.0    | ✅ Shipped | Hardening & DX: token-optimized catalog (~14%), optional `routerId` + `MIKROMCP_DEFAULT_ROUTER`, MikroMCP usage skill, MCP `instructions` on initialize, docs/wiki overhaul |
