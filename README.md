...
[![Version](https://img.shields.io/badge/version-v1.11.0-2DD4BF)](package.json)
...
[![Tools](https://img.shields.io/badge/MCP%20tools-122-0f766e)](https://github.com/AliKarami/MikroMCP/wiki/Available-Tools)
...
**122 typed tools** in total — browse the full catalog with parameters, defaults, and copy-paste example prompts in **[Available Tools](https://github.com/AliKarami/MikroMCP/wiki/Available-Tools)**.
...
MikroMCP is an open-source [Model Context Protocol](https://modelcontextprotocol.io) (MCP) server that exposes MikroTik RouterOS as 122 typed, auditable tools — letting AI assistants inspect, diagnose, and safely operate routers in natural language instead of improvising CLI commands.
...
| [Available Tools](https://github.com/AliKarami/MikroMCP/wiki/Available-Tools)                         | All 122 tools — parameters and example prompts             |
