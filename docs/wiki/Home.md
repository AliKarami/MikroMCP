...
A production-grade [Model Context Protocol (MCP)](https://modelcontextprotocol.io) server that gives AI assistants safe, structured access to MikroTik RouterOS devices. 122 typed tools. Dry-run on every write. Idempotency built in.
...
| Page | What's in it |
|---|---|
| [Available Tools](Available-Tools) | All 122 tools — parameters, defaults, example prompts |
